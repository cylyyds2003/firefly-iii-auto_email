...
def main():
    ...
    with requests.Session() as s:
        ...
        generalTableBody += '<tr><td>本月支出：</td><td style="text-align: right;">' + str(round(spentThisMonth)).replace("-", "−") + '</td></tr>'
        generalTableBody += '<tr><td>本月收入：</td><td style="text-align: right;">' + str(round(earnedThisMonth)).replace("-", "−") + '</td></tr>'
        generalTableBody += '<tr style="border-bottom: 1px solid black"><td>本月净变化：</td><td style="text-align: right;">' + str(round(netChangeThisMonth)).replace("-", "−") + '</td></tr>'
        generalTableBody += '<tr><td>今年迄今支出：</td><td style="text-align: right;">' + str(round(spentThisYear)).replace("-", "−") + '</td></tr>'
